...
public class PurchaseItemFromBabyHugBrand extends CommonAPI {
    Logger log= LogManager.getLogger(PurchaseItemFromBabyHugBrand.class.getName());
    ...
    public void mastHarbourBrandTest(){
        ...
        BabyHugBrandPage babyHugBrandPage=new BabyHugBrandPage(getDriver());
...
//        Assert.assertEquals(expectedTitle, actualTitle);
        ...
        babyHugBrandPage.clickBabyhugBrand();
        waitFor(4);
        babyHugBrandPage.clickViewProduct();
