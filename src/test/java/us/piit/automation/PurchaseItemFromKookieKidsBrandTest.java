...
public class PurchaseItemFromKookieKidsBrandTest extends CommonAPI {
    Logger log= LogManager.getLogger(PurchaseItemFromKookieKidsBrandTest.class.getName());
    ...
    @Test
    public void kookieKidsBrandTest(){
        ...
        KookieKidsBrandPage kookieKidsBrandPage=new KookieKidsBrandPage(getDriver());
...
//        Assert.assertEquals(expectedTitle, actualTitle);
        ...
        kookieKidsBrandPage.clickKookieKidsbrand();
        waitFor(4);
        kookieKidsBrandPage.clickViewProduct();
