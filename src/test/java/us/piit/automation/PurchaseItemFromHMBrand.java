...
public class PurchaseItemFromHMBrand extends CommonAPI {

    Logger log= LogManager.getLogger(PurchaseItemFromHMBrand.class.getName());
    ...
    public void hmBrandTest(){
        ...
        HMbrandPage hMbrandPage=new HMbrandPage(getDriver());
        ...
        hMbrandPage.clickHMbrand();
        waitFor(4);
        hMbrandPage.clickViewProduct();
