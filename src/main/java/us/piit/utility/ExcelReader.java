...
//            }
    ...
    public static void main(String[] args)  {
        String path = "C:\\Users\\sehso\\eclipse-workspace\\FinalProject\\data\\data.xlsx";
        ExcelReader excelReader = new ExcelReader(path);
        System.out.println(excelReader.getDataFromCell("data",2,2));
        // List<String> items =excelReader.getEntireColumnForGivenHeader("LumaTestCases", "Test Case ID"));
